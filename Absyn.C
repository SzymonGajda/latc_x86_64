...
void QuadBlk::accept(Visitor *v) {
    v->visitQuadBlk(this);
}

QuadBlk *QuadBlk::clone() const {
    return new QuadBlk(*this);
}

void QuadBlk::swap(QuadBlk &other) {
    std::swap(quadlist, other.quadlist);
}
...
QuadAss1::QuadAss1(const QuadAss1 &other) {
    res = other.res;
    arg = other.arg;
    op = other.op;
}

QuadAss1 &QuadAss1::operator=(const QuadAss1 &) {

}

void QuadAss1::accept(Visitor *v) {
    v->visitQuadAss1(this);
}

QuadAss1 *QuadAss1::clone() const {
    return nullptr;
}

void QuadAss1::swap(QuadAss1 &) {

}

QuadAss1::QuadAss1(const Ident &res, const QuadArg &arg, const String &op) : res(res), arg(arg), op(op) {}

/********************   QuadAss2    ********************/

void QuadAss2::accept(Visitor *v) {
    v->visitQuadAss2(this);
}

QuadAss2 *QuadAss2::clone() const {
    return nullptr;
}

void QuadAss2::swap(QuadAss2 &) {

}

QuadAss2::QuadAss2(const QuadAss2 &) {

}

QuadAss2 &QuadAss2::operator=(const QuadAss2 &) {
}

QuadAss2::QuadAss2(const Ident &res, const QuadArg &arg1, const QuadArg &arg2, const String &op) : res(res), arg1(arg1),
                                                                                                   arg2(arg2), op(op) {}

/********************   QuadCopy    ********************/

void QuadCopy::accept(Visitor *v) {
    v->visitQuadCopy(this);
}

QuadCopy *QuadCopy::clone() const {
    return nullptr;
}

void QuadCopy::swap(QuadCopy &) {

}

QuadCopy::QuadCopy(const QuadCopy &) {

}

QuadCopy &QuadCopy::operator=(const QuadCopy &) {
}
...
void QuadLabel::accept(Visitor *v) {
    v->visitQuadLabel(this);
}
...
void QuadLabel::swap(QuadLabel &) {

}

QuadLabel::QuadLabel(const QuadLabel &) {

}

QuadLabel &QuadLabel::operator=(const QuadLabel &) {
}

QuadLabel::QuadLabel(const Ident &label) : label(label) {}

/********************   QuadIf    ********************/

void QuadIf::accept(Visitor *v) {
    v->visitQuadIf(this);
}

QuadIf *QuadIf::clone() const {
    return nullptr;
}

void QuadIf::swap(QuadIf &) {

}

QuadIf::QuadIf(const QuadIf &) {

}

QuadIf &QuadIf::operator=(const QuadIf &) {
}

QuadIf::QuadIf(const QuadArg &cond, const Ident &label1, const Ident &label2) : cond(cond), label1(label1),
                                                                                label2(label2) {}

/********************   QuadParam    ********************/

void QuadParam::accept(Visitor *v) {
    v->visitQuadParam(this);
}

QuadParam *QuadParam::clone() const {
    return nullptr;
}

void QuadParam::swap(QuadParam &) {

}

QuadParam::QuadParam(const QuadParam &) {
...
void QuadCall::accept(Visitor *v) {
    v->visitQuadCall(this);
}
...
void QuadCall::swap(QuadCall &) {

}

QuadCall::QuadCall(const QuadCall &) {

}

QuadCall &QuadCall::operator=(const QuadCall &) {
}

QuadCall::QuadCall(const Ident &label, int argsNum) : label(label), argsNum(argsNum) {}

/********************   QuadReturn   ********************/

void QuadReturn::accept(Visitor *v) {
    v->visitQuadReturn(this);
}
...
void QuadReturn::swap(QuadReturn &) {

}

QuadReturn::QuadReturn(const QuadReturn &) {

}

QuadReturn &QuadReturn::operator=(const QuadReturn &) {
}

QuadReturn::QuadReturn(const QuadArg &ret) : ret(ret) {}
...
/*****************   QuadReturnNoVal    ***********************/
QuadReturnNoVal::QuadReturnNoVal() = default;

QuadReturnNoVal::QuadReturnNoVal(const QuadReturnNoVal &) {
...
void QuadRetrieve::accept(Visitor *v) {
    v->visitQuadRetrieve(this);
}

QuadRetrieve *QuadRetrieve::clone() const {
    return nullptr;
}

void QuadRetrieve::swap(QuadRetrieve &) {

}

QuadRetrieve::QuadRetrieve(const QuadRetrieve &) {

}

QuadRetrieve &QuadRetrieve::operator=(const QuadRetrieve &) {
}

QuadRetrieve::QuadRetrieve(const String res) : res(res) {}

/****************** QuadFunBegin  **********************************/

QuadFunBegin::QuadFunBegin() {
...
QuadFunBegin *QuadFunBegin::clone() const {
    return nullptr;
}

void QuadFunBegin::swap(QuadFunBegin &) {

}

QuadFunBegin::QuadFunBegin(const QuadFunBegin &) {

}

QuadFunBegin &QuadFunBegin::operator=(const QuadFunBegin &) {
}
